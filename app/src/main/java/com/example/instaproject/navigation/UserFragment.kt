...
import com.example.instaproject.LoginActivity
import com.example.instaproject.MainActivity
import com.example.instaproject.R
import com.example.instaproject.navigation.model.AccountDTO
import com.example.instaproject.navigation.model.AlarmDTO
import com.example.instaproject.navigation.model.ContentDTO
import com.example.instaproject.navigation.model.FollowDTO
import com.example.instaproject.navigation.util.AccountNameDialog
...
class UserFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        fragmentView?.account_set_name?.setOnClickListener {
            setAccountName()
        }
        getProfileImage()
    ...
    fun setAccountName(){
        ...
        builder.setTitle("Account Name Set")
        // Set up the input
        ...
        builder.setPositiveButton("OK", DialogInterface.OnClickListener { dialog, which ->
            accountName = input.text.toString()
            var accountname = AccountDTO()
            accountname.accountName = accountName
            var uid : String? = FirebaseAuth.getInstance().currentUser?.uid
            FirebaseFirestore.getInstance().collection("accountname").document(uid!!).set(accountname!!)
            fragmentView?.account_nick_name?.setText(accountname.accountName!!)
            keyboardHide()
        })
    ...
    fun keyboardHide(){
        ...
        imm.hideSoftInputFromWindow(account_nick_name.windowToken, 0)
    }
    ...
    fun getProfileImage(){
        ...
        firestore?.collection("accountname")?.document(uid!!)?.addSnapshotListener { documentSnapshot, firebaseFirestoreException ->
            ...
            if (documentSnapshot.data != null) {
                ...
                fragmentView?.account_nick_name?.setText(name!!)
            }
        }
    }
